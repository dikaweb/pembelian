...
<script type="text/javascript">
    ...
    $('#modalpilihpenerima').on('click', '#btnmdlpilihpenerima', function() {
        if ($('#jenis').val() == "penerima") {
            $('#lblnm_pn').text($(this).data('alamat_pn'));
            $('#lblkd_pn').text($(this).data('nm_penerima'));
            $('#txtid_pn').val($(this).data('id'));
            $('#txtup').val($(this).data('up_pn'));
        } else {
            $('#lblnm_kr').text($(this).data('alamat_pn'));
            $('#lblkd_kr').text($(this).data('nm_penerima'));
            $('#txtid_kr').val($(this).data('id'));
        }
    });
    ...
    $('#modalpilihpenerima').on('click', '#btnmdleditpenerima', function() {
        ...
        $("#btnsimpanpenerima").attr("class", "btn btn-info  col-sm-2 mt-1 btn-sm");
        $('#alamat_pn').val($(this).data('alamat_pn'));

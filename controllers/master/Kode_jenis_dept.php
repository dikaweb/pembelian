...
class kode_jenis_dept extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->db->join('lokasi_group', 'lokasi_group.id_lokasi_group=m_kode_jenis_dept.id_lokasi_group', 'left');
        ...
        $data['lokasi_group'] = $this->db->get('lokasi_group')->result_array();
    ...
    public function update()
    {
        ...
        $this->id_lokasi_group = $this->input->post('lokasi_group');
    ...
    public function save()
    {
        ...
        $this->id_lokasi_group = $this->input->post('lokasi_groupt');
